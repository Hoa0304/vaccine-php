    ...
    <div class="navigation">
        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $sqlvc = "select VID,Name, Desciption,Image, Price from vtype";
                ...
                require_once "../controller/connectiondb.php";
                $cid = $_SESSION['CID'];
                $sqlimg = "select avt from customer where CID = '$cid'";
                $imgrs = mysqli_query($conn, $sqlimg);
                $imglink = "https://png.pngtree.com/png-vector/20190820/ourmid/pngtree-no-avatar-vector-isolated-on-white-background-png-image_1694546.jpg";
                if($imgrs->num_rows>0){
                    while($row = mysqli_fetch_array($imgrs)){
                       if($row['avt']!==""){
                        $imglink = $row['avt'];
                       }
                    }
